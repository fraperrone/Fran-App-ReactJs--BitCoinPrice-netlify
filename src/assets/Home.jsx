  ...
  return (
    <>
      <Card style={{ width: '18rem' }}>
        <Card.Img
          variant="top"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRli613TiDL6hCdb2_Akb8ZAz2Wn8R-AaXi6aHzMGsxCGo_ywzCYM9hletq5hUhq5eORvw&usqp=CAU"
        ...
        `}
          ...
          <Card.Title>
            Actualizacion Time zone UK:<br></br>
            {data.time.updateduk}
          </Card.Title>
        </Card.Footer>
      </Card>
